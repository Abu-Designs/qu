...
Calendar.prototype.nextMonth = function () {
    ...
    var arabicMonths = ["يناير", "فبراير", "مارس", "ابريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"]
    ...
    var r = (new Date).getDate(),
        ...
        s = "<span class='arabic-month'> <span>" + arabicMonths[e] + "</span> <br /> <span class='calender-year'>" + t + "</span><br /><span>" + this.Months[e] + "</span></span>",
        d = '<div class="table">';
    ...
    for (var h, l = dm = "M" == this.f ? 1 : 0 == o ? -5 : 2, v = (c = 0, 0); v < 6; v++) {
        ...
        for (var m = 0; m < 7; m++) {
            ...
            else if(r == h && this.CurrentMonth == n && this.CurrentYear == a){
                d += '<div onclick="onDayEventClick('+h+')" class="cell active"><span>' + h + "</span><div class='active-hidden hid"+h+"'>My Event <br/> 2:00 PM - 3:00 PM</div></div>", l = 1               
            }else{
                d += '<div class="cell"><span>' + h + "</span></div>", l = 1               
            }
            c % 7 == 6 && h >= i && (v = 10), c++
        }
        d += "</div>"
...
function onDayEventClick(e){
    if(document.querySelector(".hid" +e).style.display == "block")
        document.querySelector(".hid" +e).style.display = "none";
    else
        document.querySelector(".hid" +e).style.display = "block";
}